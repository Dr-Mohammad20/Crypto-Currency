...
const GreenCoins = () => {
  ...
  const currentPosts = greenCoins.slice(indexOfFirstPost, indexOfLastPost);
  /////////////////////////////
  // change Page
            ...
            <div className={style.APIInfo}>
              {currentPosts.map((item, index) => (
                ...
                >
                  ...
                  <div>
                    <p className={style.coinInApiName}>{item.name}</p>
                  </div>
                  <div>
                    <p>{item.symbol}</p>
                  </div>
